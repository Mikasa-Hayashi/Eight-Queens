...
class TestFindNewAcceptablePosition {
    ...
    */
    ...
    void singleQueenFirstPos() {
        ...
        Desk d = new Desk();
        Point[] queen_pos = { new Point(1, d.rowBelowDesk() ) };
        d.setQueens(queen_pos);
    ...
    void singleQueenLastPos() {
        ...
        Desk d = new Desk();
        Point[] queen_pos = { new Point(1, d.rowCount()-1 ) };
        d.setQueens(queen_pos);

        Point exp_pos = new Point(1, d.rowCount());
        boolean exp_ok = true;
    ...
    void singleQueenNotPos() {
        ...
        Desk d = new Desk();
        Point[] queen_pos = { new Point(1, d.rowCount() ) };
        d.setQueens(queen_pos);
    ...
    void LastPosForFirstQueen() {
        ...
        Point[] exp_pos = { new Point(1, d.rowCount()), new Point(2, 1) };
        boolean exp_ok = true;
    ...
    void NotAcceptablePos() {
        ...
        Point[] exp_pos = { new Point(1, d.rowAboveDesk()), new Point(2, d.rowAboveDesk()) };
        boolean exp_ok = false;
